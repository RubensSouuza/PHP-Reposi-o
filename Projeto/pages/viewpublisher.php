...
$control = $conecta->prepare("SELECT * FROM tb_editora ORDER BY nome asc");
$control->execute();
            ...
            foreach ($resultado as $rows) {
             ...
             <div class = 'card mt-3 mb-3 mr-3' style = 'widith: 15rem; font-size: 13px; box-shadow: 0 0 1em; '>
                 ...
                 <div class = 'card-body'>
                     ...
                     <p class = 'card-text'> <strong> CNPJ: </strong>".$rows['cnpj']." </p>

                     <p class = 'card-text'> <strong> Telefone: </strong>".$rows['telefone']." </p>

                     <p class = 'card-text'> <strong> Endereço: </strong>".$rows['endereco']." </p>

                     <a href='#' class='btn btn-success'> Ler </a>
                     <a href='../DB/deletepublisher.php?id=". $rows['id'] . "' class='btn btn-danger'> Deletar</a>
